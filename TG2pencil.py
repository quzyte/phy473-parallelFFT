from numpy import*
from numpy.fft import fftfreq,fft,ifft,irfft2,rfft2,rfft
...
Uc_hat_x=empty((N,Np,N/2+1),dtype=complex)
Uc_hat_y=empty((N,Np,N/2+1),dtype=complex)
Uc_hat_z=empty((N,Np,N/2+1),dtype=complex)
